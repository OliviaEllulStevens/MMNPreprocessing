...
Current_File_Path = '/Users/oliviastevens/Documents/ERP_CORE-master/MMN_RecChannels-OliviaScripts/EEG_ERP_Processing/Grand_Average_ERPs';
...
%%%% ERP, [9 10], [32 34 35 18]
%%%% 9,10,11 = BINS, 32,33,35,18 = ELECTRODE CHANNELS
...
ERP = pop_ploterps( ERP, [11], [32 34 35 18] , 'SEM', 'on', 'Transparency',  0.8, 'Box', [2 2], 'blc', baselinecorr, 'Maximize', 'on', 'Style', 'Classic', 'xscale', xscale,  'yscale', yscale_EEG_diff);
